...
internal static class CrashReporter
{
	...
	private unsafe static void Capture(nint exceptionPointers, string phase, bool writeMinidump = false)
	{
		try
		{
			...
			stringBuilder.AppendLine("MChub Bedrock Preload Crash Report");
	...
	private unsafe static string DetermineOwner(nint address)
	{
		...
		if (fileName.StartsWith("MChub.Preload", StringComparison.OrdinalIgnoreCase) || fileName.StartsWith("MChub.XUserHook", StringComparison.OrdinalIgnoreCase))
		{

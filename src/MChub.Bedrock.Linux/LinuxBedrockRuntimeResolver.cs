...
public sealed class LinuxBedrockRuntimeResolver
{
    ...
    private static string ResolvePrefixPath()
    {
        ...
        return Path.Combine(GetDataHome(), "MChub", "Bedrock", "proton-prefix");
    }
    ...
    private static string ResolveSteamCompatPath()
    {
        ...
        var managed = Path.Combine(GetDataHome(), "MChub", "Bedrock", "steam-client");
    ...
    private static string GetProtonInstallRoot() => Path.Combine(GetDataHome(), "MChub", "Bedrock", "proton");
    ...
    private static string GetCacheRoot()
    {
        ...
        return string.IsNullOrWhiteSpace(cacheHome)
            ? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".cache", "MChub", "Bedrock")
            : Path.Combine(Path.GetFullPath(cacheHome), "MChub", "Bedrock");
    }

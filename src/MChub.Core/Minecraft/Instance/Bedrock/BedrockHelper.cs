...
public class BedrockHelper
{
    ...
    public static readonly string ConfigFolder = Path.Combine("config", "MChub");
    private static readonly string LegacyConfigFolder = Path.Combine("config", "MChub.Desktop");

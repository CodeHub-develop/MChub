...
public static class MinecraftLaunchService
{
        ...
        IReadOnlyList<string> extraGameArguments)
    {
        ...
        [
            ...
            string.Format(LogLanguageManager.Instance.launch_startupMChubVersion.CurrentValue(), MinecraftCoreInitializer.AppVersion),
        ...
        MinecraftLogSession logSession, TaskCompletionSource processExit, Action<Process> processStarted)
    {
        ...
        {
            var text = $"[MChub/Bedrock] {message}";
...
public sealed class MChubGameArgumentParser : IArgumentParser
{
    private readonly IArgumentParser _inner;
    private readonly IReadOnlyList<string> _extraGameArguments;

    public MChubGameArgumentParser(IArgumentParser inner, IReadOnlyList<string> extraGameArguments)
    {
        _inner = inner;

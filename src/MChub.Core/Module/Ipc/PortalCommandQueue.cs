...
public static class MChubCommandQueue
{
    private static readonly Queue<MChubCommand> PendingCommands = [];
    private static readonly object CommandLock = new();
    private static bool _isReady;
    private static bool _initialized;

    public static Func<MChubCommand, Task>? ExecutionHandler { get; set; }
    ...
    public static void Enqueue(MChubCommand command)
    {
        bool isReady;
        lock (CommandLock)
        {

...
public static class DesktopShortcutService
{
    public static string BuildLaunchUrl(MinecraftInstance instance)
    {
        ...
        return $"mchub://launch?id={Uri.EscapeDataString(id)}&folder={Uri.EscapeDataString(instance.FolderPath)}";
    }
    ...
    private static string SanitizeFileName(string name)
    {
        ...
        return string.IsNullOrEmpty(result) ? "MChub" : result;
    }
    ...
    private static string CreateWindowsShortcut(string url, string displayName, Bitmap? icon)
    {
        ...
        try
        {
            ...
            link.SetDescription(string.Format(CommonLanguageManager.Instance.desktop_launchViaMChub.CurrentValue(), displayName));
    ...
    private static async Task<string> CreateLinuxShortcutAsync(string url, string displayName, Bitmap? icon)
    {
        ...
        builder.AppendLine($"Comment={string.Format(CommonLanguageManager.Instance.desktop_launchViaMChub.CurrentValue(), EscapeDesktopValue(displayName))}");

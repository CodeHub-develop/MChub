...
public static class BedrockModManager
{
    ...
    public static readonly string MChubConfigFolder = Path.Combine("config", "MChub");
    ...
    public static string GetModsFolder(BedrockInstanceConfig config) =>
        Path.Combine(config.InstancePath, MChubConfigFolder, ModsFolderName);

    public static string GetConfigPath(BedrockInstanceConfig config) =>
        Path.Combine(config.InstancePath, MChubConfigFolder, ConfigFileName);

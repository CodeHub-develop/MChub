...
public partial class CustomHomepageView : UserControl
{
    ...
    private static async Task<string> LoadPresetAsync(int index)
    {
        ...
        if (index == 0)
            return
                "<pcl:MyCard Title=\"Trivia\" xmlns:pcl=\"clr-namespace:MChub.Views.Pages;assembly=MChub\"><TextBlock Text=\"Minecraft\" Margin=\"20\" TextWrapping=\"Wrap\" /></pcl:MyCard>";
        if (index == 1) return string.Empty;
        if (index == 15)
            return
                "<pcl:MyCard Title=\"Minecraft Official Feed\" xmlns:pcl=\"clr-namespace:MChub.Views.Pages;assembly=MChub\"><TextBlock Text=\"Minecraft news feed\" Margin=\"20\" /></pcl:MyCard>";
    ...
    private static Control ParseContent(string content)
    {
        ...
        content =
            $"<StackPanel xmlns=\"https://github.com/avaloniaui\" xmlns:x=\"http://schemas.microsoft.com/winfx/2006/xaml\" xmlns:sys=\"clr-namespace:System;assembly=System.Runtime\" xmlns:d=\"http://schemas.microsoft.com/expression/blend/2008\" xmlns:mc=\"http://schemas.openxmlformats.org/markup-compatibility/2006\" xmlns:pcl=\"clr-namespace:MChub.Views.Pages;assembly=MChub\">{content}</StackPanel>";

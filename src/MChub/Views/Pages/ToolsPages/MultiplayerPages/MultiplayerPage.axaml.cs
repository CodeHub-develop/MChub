...
namespace MChub.Views.Pages.ToolsPages.MultiplayerPages;
...
public partial class MultiplayerPage : UserControl, ITioTabPage
{
    ...
    {
        InitializeComponent();
        _terracottaIcon = DecodeNavigationIcon("avares://MChub/Assets/Multiplayer/terracotta.png");
        TerracottaNavIcon.Source = _terracottaIcon;
        _terracottaBigIcon = DecodeNavigationIcon("avares://MChub/Assets/Multiplayer/terracotta.png", 28);

...
{
    public string ResourceUri => $"resm:{ResourceName}?assembly=MChub.Core";
...
{
    private const string McIconResourcePrefix = "MChub.Core.Assets.McIcons.";

...
using MChub.Core.Minecraft.Modpack;
...
public partial class ModpackExportDialogViewModel : ObservableObject, IDialogContext
{
    ...
    public ModpackExportDialogViewModel(MinecraftInstance instance)
    {
        ...
        BuildOptions();
        IncludeMChubIcon = CanExportMChubIcon;
    }
    ...
    [ObservableProperty] public partial bool IncludeMChubSettings { get; set; }
    [ObservableProperty] public partial bool IncludeMChubIcon { get; set; }
    ...
    public bool CanExportMChubIcon => _instance.GetExportIconPath() != null;
    ...
    private void Confirm()
    {
        ...
        var options = new ModpackExportOptions
        {
            ...
            IncludeMChubSettings = IncludeMChubSettings,
            IncludeMChubIcon = IncludeMChubIcon
        };

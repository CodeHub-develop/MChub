...
internal static partial class WindowsBedrockFileAssociationService
{
    ...
    [
        (".mcpack", "MChub.Minecraft.Mcpack", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mcpack.CurrentValue()),
        (".mcaddon", "MChub.Minecraft.Mcaddon", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mcaddon.CurrentValue()),
        (".mcworld", "MChub.Minecraft.Mcworld", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mcworld.CurrentValue()),
        (".mctemplate", "MChub.Minecraft.Mctemplate", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mctemplate.CurrentValue())
    ];
    ...
    public static void Register()
    {
        try
        {
            ...
            foreach (var association in Associations)
            {
                ...
                application.SetValue("ApplicationName", "MChub");
            ...
            {
                application.SetValue("FriendlyAppName", "MChub");

using MChub.Bedrock.Xbox;
using MChub.Localization;

namespace MChub.Bedrock;

internal sealed class MChubXUserLauncher(string instancePath)
{
    private const string HookResourceName = "MChub.Bedrock.XUserHook.dll";
    ...
    public void DeployHook()
    {
        ...
        var hookPath = Path.Combine(preloadDirectory, "MChub.XUserHook.dll");
        using var input = typeof(MChubXUserLauncher).Assembly.GetManifestResourceStream(HookResourceName)

...
pkgname=mchub-commit-bin
pkgver=0.0.0.0
pkgrel=1
pkgdesc="MChub - Minecraft launcher/manager (commit build, prerelease)"
arch=('x86_64')
url="https://codehub-develop.github.io/MChub/"
license=('GPL-3.0-or-later')
depends=('fuse2' 'hicolor-icon-theme' 'xdg-utils')
provides=("mchub=$pkgver")
conflicts=('mchub' 'mchub-nightly-bin' 'mchub-bin')
options=('!strip' '!emptydirs')
_appimg="MChub.AppImage"
source_x86_64=(
    "$_appimg::https://github.com/CodeHub-develop/MChub/releases/download/publish-commit/MChub.linux.x64.AppImage"
